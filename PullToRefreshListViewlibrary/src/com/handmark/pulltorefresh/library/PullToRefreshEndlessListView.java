...
public class PullToRefreshEndlessListView extends
		PullToRefreshAdapterViewBase<EndlessListview> {
	...
	public PullToRefreshEndlessListView(Context context, Mode mode) {
		super(context, mode);
	}
	...
	protected EndlessListview createListView(Context context, AttributeSet attrs) {
		final EndlessListview lv;
	...
	@Override
	protected EndlessListview createRefreshableView(Context context,
			AttributeSet attrs) {
		EndlessListview lv = createListView(context, attrs);

		// Set it to this so it can be used in ListActivity/ListFragment
		lv.setId(android.R.id.list);
		// 让Endless自己的onscroll生效
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			OverscrollHelper.overScrollBy(PullToRefreshEndlessListView.this,
	...
	protected class InternalListView extends EndlessListview implements
		...
		public void setEmptyView(View emptyView) {
			PullToRefreshEndlessListView.this.setEmptyView(emptyView);
		}
