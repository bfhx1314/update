...
public class PinnedHeaderListView extends EndlessListview implements OnScrollListener {
	...
	public static abstract class OnItemClickListener implements
		...
		@Override
		public void onItemClick(AdapterView<?> adapterView, View view, int rawPosition,
				long id) {
		...
		public abstract void onSectionClick(AdapterView<?> adapterView, View view,
				int section, long id);
