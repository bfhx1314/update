...
public class PullToRefreshStickyListView extends
		PullToRefreshAdapterViewBase<StickyListView> {
	...
	public PullToRefreshStickyListView(Context context, Mode mode) {
		super(context, mode);
	}
	...
	protected StickyListView createListView(Context context, AttributeSet attrs) {
		final StickyListView lv;
		// if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
		lv = new StickyListView(context, attrs);
	...
	@Override
	protected StickyListView createRefreshableView(Context context,
			AttributeSet attrs) {
		StickyListView lv = createListView(context, attrs);
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX,
			...
			OverscrollHelper.overScrollBy(PullToRefreshStickyListView.this,
	...
	protected class InternalListView extends ListView implements
		...
		public void setEmptyView(View emptyView) {
			PullToRefreshStickyListView.this.setEmptyView(emptyView);
		}
